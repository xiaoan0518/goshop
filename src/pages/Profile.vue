<template>
  <section class="profile">
    ...
    <section class="profile-number">
      <router-link :to="user._id?'/msite':'/login'" class="profile-link">
        <div class="profile_image">
          <i class="iconfont icon-person"></i>
        </div>
        <div class="user-info">
          <p class="user-info-top" v-show="user.name">
            {{user.name?user.name:'登录/注册'}}
          </p>
          <p>
            <span class="user-icon" v-show="user.phone">
...
export default {
  ...
  methods: {
    deletUser(){
      // 删除清空user，退出登录
      this.$store.dispatch('deletusers')
    }
  },
    props: {
