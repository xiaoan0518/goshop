<template>
  <div class="shop-header">
    ...
    <div class="shop-content" >
      ...
      <div class="header-content">
        <h2 class="content-title">
          ...
          <span class="content-name" @click="isshowAffiche=true">{{info.name}}</span>
    ...
    <div class="shop-header-discounts">
      ...
      <div class="discounts-right" @click="isshowLIst=true">
        3个优惠
      </div>
    </div>
    <div class="shop-brief-modal" v-show="isshowAffiche">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isshowAffiche=false"  >xxx</span>
        </div>
      </div>
      <div class="brief-modal-cover" ></div>
    </div>
    <div class="activity-sheet" v-show="isshowLIst">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isshowLIst=false" >xxx</span>
        </div>
      </div>
